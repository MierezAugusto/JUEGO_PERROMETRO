...
class Menu():   #creo una clase y la llamo menu
    ...
    def draw_cursor(self):  #funcion para darle forma al cursor
        self.game.draw_text("►", 22, self.cursor_rect.x+25, self.cursor_rect.y)    #reutilizamos la funcion para darle forma al texto 
...
class MainMenu(Menu):   #clase de menu principal que hereda las funciones de la clase Menu
    ...
    def display_menu(self): #funcion para mostrar el menu
        ...
        while self.run_display: #mientras la variable de arriba sea true
            ...
            background = pygame.transform.scale(pygame.image.load("Juego-En-Python//bg.png"), (self.game.DISPLAY_W, self.game.DISPLAY_H)) #Seteo el fondo, escalandolo al tamaño de la pantalla
...
class ControlMenu(Menu):
    ...
    def display_menu(self): #Funcion para lanzar el menu de controles
        ...
        while self.run_display:
            ...
            flechitaspng = pygame.image.load("Juego-En-Python//images//FlechasPng.png")   #cargo la imagen de las flechas
            ...
            wasdpng = pygame.image.load("Juego-En-Python//images//wasdPng.png")   #cargo la imagen de las teclas wasd
