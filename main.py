...
#agrego la musica
pygame.mixer.music.load("Juego-En-Python//music//battle.wav")
pygame.mixer.music.play(-1)

#Pantalla del juego
perro = pygame.image.load("Juego-En-Python//perro//izquierda//1.png") #Agrego imagen para la pantalla de game over
background = pygame.transform.scale(pygame.image.load("Juego-En-Python//bg.png"), (g.DISPLAY_W, g.DISPLAY_H)) #Seteo el fondo, escalandolo al tamaño de la pantalla
pygame.display.set_caption("Perrometro") 
...
def main():
    ...
    def gameover_window():
        ...
        death_label = lost_font.render("No has podido evitar al perro",1,(25,25,25)) #Muestro mensaje de muerte
        score_label = lost_font.render(f"Has llegado al nivel: {player.level+1}",1,(25,25,25)) #Muestro hasta que nivel llego el jugador
        restart_label = lost_font.render("Toca cualquier flecha para reiniciar",1,(25)) #Muestro instrucciones para reinicio
        g.window.blit(perro,(300,500))
